...
class ThirdStageMarkView: UIView {
    ...
    private let titleLarge = UILabel(text: "Сделай отметку первого этапа закаливания",
    ...
    private func configuraButtonMark(text: String) -> UIButton {
        ...
        button.backgroundColor = .specialTextButton
    ...
    @objc func tapButtonMark(button: UIButton) {
        ...
        button.setImage(UIImage(systemName: "checkmark")?.withTintColor(.specialTextButton).withRenderingMode(.alwaysOriginal), for: .normal)
